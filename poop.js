(function () {
    ...
    /*  new Confetti(options)
    *   - Generates random confetti
    *
    *   @options.
    {DOM}(Required) - Target DOM element where confetti will be rendered
    *   @options.ondone {Function}(Optional) - Fires after @t.vars.confetiLimit is reached
    *   @options.onstart {Function}(Optional) - Fires before confeti rain begins
    */
    class Confetti {
        constructor(options) {
            this.o = options || {};
        ...
        handleOptions() {
            ...
            if (!!this.o.onstart) {
                this.callbacks.onstart = this.o.onstart;
            }

            if (!!this.o.ondone) {
                this.callbacks.ondone = this.o.ondone;
            }
